...
/// Client-side health encryption. The AES-256 key is generated on-device and
/// stored only in the OS secure storage. Supabase receives ciphertext only.
class HealthE2eeService {
  ...
  Future<List<Map<String, String>>> encryptSamples(
    List<PaceHealthSample> samples,
  ) async {
