...
export function AiLocalModeSettings() {
  ...
  return (
    <div className="space-y-4 pt-4 border-t border-border">
      <div className="flex items-start gap-3"><Cpu className="size-4 mt-0.5 text-primary" /><div><div className="font-medium">IA locale</div><div className="text-xs text-muted-foreground">Le modèle tourne dans votre navigateur avec WebGPU. Les requêtes locales prises en charge ne quittent pas l’appareil.</div></div></div>
