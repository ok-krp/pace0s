        ...
        <div className="glass-card max-w-md w-full p-8 text-center">
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-2 justify-center">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 rounded-xl border border-border bg-card px-4 py-2.5 text-sm font-medium hover:bg-muted transition-colors"
            >
