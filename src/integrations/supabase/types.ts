  ...
  public: {
    Tables: {
      ...
      food_scans: {
        ...
        Insert: { barcode?: string | null; brand?: string | null; carbs_g?: number | null; created_at?: string; fat_g?: number | null; favorite?: boolean | null; fiber_g?: number | null; health_score?: string | null; id?: string; image_url?: string | null; ingredients?: string | null; kcal?: number | null; kind: string; nova_group?: number | null; nutri_score?: string | null; product_name?: string | null; protein_g?: number | null; raw?: Json | null; salt_g?: number | null; sodium_mg?: number | null; sugar_g?: number | null; user_id: string; warnings?: string[] | null }
      ...
      push_subscriptions: {
        Row: { id: string; user_id: string; onesignal_subscription_id: string; platform: string; created_at: string; updated_at: string }
        Insert: { id?: string; user_id: string; onesignal_subscription_id: string; platform?: string; created_at?: string; updated_at?: string }
        Update: { id?: string; user_id?: string; onesignal_subscription_id?: string; platform?: string; created_at?: string; updated_at?: string }
        Relationships: []
      }
      reminder_debug_log: {
      ...
      reminder_settings: {
        ...
        Update: { created_at?: string; enabled?: boolean; id?: string; threshold?: number | null; time_local?: string; timezone?: string; type?: string; updated_at?: string; user_id?: string }
        Relationships: []
      }
      user_state: {
        Row: { created_at: string; id: string; key: string; updated_at: string; updated_by: string | null; user_id: string; value: Json | null }
        Insert: { created_at?: string; id?: string; key: string; updated_at?: string; updated_by?: string | null; user_id: string; value?: Json | null }
        Update: { created_at?: string; id?: string; key?: string; updated_at?: string; updated_by?: string | null; user_id?: string; value?: Json | null }
        Relationships: []
      }
    }
    ...
    Functions: {
      upsert_profile_if_newer: {
        Args: { p_user_id: string; p_profile: Json; p_updated_at: string; p_updated_by: string }
        Returns: boolean
      }
      upsert_user_state_if_newer: {
        Args: { p_user_id: string; p_key: string; p_value: Json; p_updated_at: string; p_updated_by: string }
        Returns: boolean
      }
    }
