...
function WorkPage() {
  ...
  return <div className="work-page">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1.55fr)_minmax(0,1fr)] gap-4 items-stretch">
      <section className="glass-card p-5 lg:row-span-2 min-h-[560px]">
