-- PACE — Cloud sync repair
-- Ensures the RPC used by the web client exists and is callable by authenticated users.
-- This is intentionally idempotent so it is safe to apply after the existing sync migrations.
