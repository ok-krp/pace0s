...
BEGIN
  ...
  INSERT INTO public.profiles (
    id, user_id, display_name, email, age, sex, height_cm, weight_kg, weight_goal_kg,
    body_fat_goal_pct, muscle_mass_goal_pct, daily_calorie_goal, daily_protein_goal,
    daily_water_ml_goal, training_goal, activity_level, training_sessions_goal,
    ...
    p_profile->>'training_goal', p_profile->>'activity_level',
    COALESCE(NULLIF(p_profile->>'training_sessions_goal', '')::integer, 3),
    effective_updated_at, p_updated_by
  )
