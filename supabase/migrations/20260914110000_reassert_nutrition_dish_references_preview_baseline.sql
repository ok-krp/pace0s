-- Supabase Preview can retain a schema baseline older than the repository
-- migration history. Reassert the live-compatible table here so preview
-- schema diffs never assume nutrition_dish_references already exists.
