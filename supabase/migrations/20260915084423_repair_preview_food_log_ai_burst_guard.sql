-- Compatibility repair for the Preview migration history.
-- Preview recorded this migration version before the repair was restored in source control.
-- Keep the migration idempotent so fresh environments and Preview converge safely.
